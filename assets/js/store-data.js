...
window.MADAWIN_PRODUCTS = [
  /* ─── VINHOS ─── */
  { slug:"vinha-grande-tto", category:"vinhos", name:"Vinha Grande Tinto 750ml", old_price:199.99, pix_price:149.99, installments:"3x de R$ 54,17", credit_price:"R$ 157,89 no crédito", tags:["Tinto","Portugal","750ml"] },
  { slug:"freixenet-pinot-grigio", category:"vinhos", name:"Freixenet Pinot Grigio Branco 750ml", old_price:99.99, pix_price:69.99, installments:"3x de R$ 24,71", credit_price:"R$ 73,67 no crédito", tags:["Branco","750ml"] },
  { slug:"sea-sun-rose", category:"vinhos", name:"Sea Sun Rosé 750ml", old_price:109.99, pix_price:79.99, installments:"3x de R$ 28,24", credit_price:"R$ 84,20 no crédito", tags:["Rosé","Chile","750ml"] },
  { slug:"verde-casal-garcia", category:"vinhos", name:"Verde Casal Garcia Branco 750ml", old_price:99.99, pix_price:69.99, installments:"3x de R$ 24,71", credit_price:"R$ 73,67 no crédito", tags:["Branco","Portugal","750ml"] },
  { slug:"mimi-provence-rose", category:"vinhos", name:"Mimi Côtes de Provence Rosé 750ml", old_price:269.99, pix_price:195.99, installments:"3x de R$ 69,12", credit_price:"R$ 206,31 no crédito", tags:["Rosé","França","750ml"] },
  { slug:"cristatus-merlot", category:"vinhos", name:"Cristatus Merlot Reserva Tinto 750ml", old_price:129.90, pix_price:89.90, installments:"3x de R$ 31,72", credit_price:"R$ 94,63 no crédito", tags:["Tinto","750ml"] },
  { slug:"cristatus-cabernet", category:"vinhos", name:"Cristatus Cabernet Sauvignon Reserva Tinto 750ml", old_price:129.90, pix_price:89.90, installments:"3x de R$ 31,72", credit_price:"R$ 94,63 no crédito", tags:["Tinto","750ml"] },
  { slug:"luigi-bosca-malbec", category:"vinhos", name:"Luigi Bosca Malbec Tinto 750ml", old_price:139.99, pix_price:99.99, installments:"3x de R$ 35,29", credit_price:"R$ 105,25 no crédito", tags:["Tinto","Argentina","750ml"] },
  { slug:"catena-alta-malbec", category:"vinhos", name:"Catena Alta Malbec Tinto 750ml", old_price:399.99, pix_price:299.99, installments:"3x de R$ 105,88", credit_price:"R$ 315,78 no crédito", tags:["Tinto","Argentina","750ml"] },
  { slug:"esporao-reserva", category:"vinhos", name:"Esporão Reserva Tinto 750ml", old_price:299.90, pix_price:220.00, installments:"3x de R$ 77,59", credit_price:"R$ 231,58 no crédito", tags:["Tinto","Portugal","750ml"] },
  { slug:"nicolas-catena-zapata", category:"vinhos", name:"Nicolas Catena Zapata 750ml", old_price:1199.90, pix_price:900.00, installments:"10x de R$ 97,90", credit_price:"R$ 947,37 no crédito", tags:["Tinto","Argentina","Premium","750ml"] },
  { slug:"loma-negra-cabernet", category:"vinhos", name:"Loma Negra Gran Reserva Cabernet Sauvignon 750ml", old_price:99.99, pix_price:69.99, installments:"3x de R$ 24,71", credit_price:"R$ 73,67 no crédito", tags:["Tinto","Chile","750ml"] },
  { slug:"casillero-diablo-pedro", category:"vinhos", name:"Casillero del Diablo Reserva Pedro Jiménez 750ml", old_price:69.90, pix_price:48.90, installments:"3x de R$ 17,25", credit_price:"R$ 51,47 no crédito", tags:["Branco","Chile","750ml"] },
  { slug:"pe-branco", category:"vinhos", name:"Pé Branco 750ml", old_price:59.99, pix_price:39.99, installments:"3x de R$ 14,12", credit_price:"R$ 42,10 no crédito", tags:["Branco","Portugal","750ml"] },
  { slug:"pe-tinto", category:"vinhos", name:"Pé Tinto 750ml", old_price:59.90, pix_price:42.90, installments:"3x de R$ 15,14", credit_price:"R$ 45,16 no crédito", tags:["Tinto","Portugal","750ml"] },
  { slug:"quinta-bons-ventos-tto", category:"vinhos", name:"Quinta dos Bons Ventos Tinto 750ml", old_price:79.99, pix_price:49.99, installments:"3x de R$ 17,64", credit_price:"R$ 52,62 no crédito", tags:["Tinto","Portugal","750ml"] },
  { slug:"quinta-bons-ventos-br", category:"vinhos", name:"Quinta dos Bons Ventos Branco 750ml", old_price:79.99, pix_price:49.99, installments:"3x de R$ 17,64", credit_price:"R$ 52,62 no crédito", tags:["Branco","Portugal","750ml"] },
  ...
  { slug:"intruso-branco", category:"vinhos", name:"Intruso Branco 750ml", old_price:89.90, pix_price:59.50, installments:"3x de R$ 20,99", credit_price:"R$ 62,63 no crédito", tags:["Branco","750ml"] },
  { slug:"tropical-rose-frisante", category:"vinhos", name:"Tropical Rosé Frisante 750ml", old_price:39.90, pix_price:25.90, installments:"3x de R$ 9,14", credit_price:"R$ 27,26 no crédito", tags:["Frisante","Rosé","750ml"] },
  { slug:"almaden-frisante-rose", category:"vinhos", name:"Almadén Frisante Rosé 750ml", old_price:49.90, pix_price:29.95, installments:"3x de R$ 10,57", credit_price:"R$ 31,53 no crédito", tags:["Frisante","Rosé","750ml"] },
  { slug:"casal-garcia-sweet", category:"vinhos", name:"Casal Garcia Sweet Tinto 750ml", old_price:99.99, pix_price:69.99, installments:"3x de R$ 24,71", credit_price:"R$ 73,67 no crédito", tags:["Tinto","Portugal","750ml"] },
